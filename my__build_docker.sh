...
#sudo docker build -t llvm-mingw-my00 -f Dockerfile.my00 . 
# sudo docker container run  -v $(pwd):/build/llvm-mingw  -v $(pwd)/../build:/build/build -it llvm-mingw-my00 bash
...
sudo docker build -t llvm-mingw-my1.0 -f Dockerfile.my1.0 . 
# sudo docker container run  -v $(pwd):/build/llvm-mingw  -v $(pwd)/../build:/build/build -it llvm-mingw-my1.0 bash
